...
**Working directory for every command below:** the repo root of the `mengo/phase-2-memory` worktree — `/Users/your-user/screenpipe/.claude/worktrees/mengo-phase-1-shell` (the directory containing `Package.swift`; it holds the `mengo/phase-2-memory` branch).
