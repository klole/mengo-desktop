...
expected_lines = [
    ...
    f"- Release downloads: {asset.get('downloadCount')}, generated by repeated maintainer smoke checks.",
]
...
do_not_claim_downloads = (
    ...
    f"{repo.get('forkCount')} forks, and {asset.get('downloadCount')} maintainer-generated release downloads."
)
